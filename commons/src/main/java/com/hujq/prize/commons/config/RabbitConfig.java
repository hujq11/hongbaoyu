package com.hujq.prize.commons.config;
...
public class RabbitConfig {
   ...
   //绑定队列路由
    ...
    public RabbitTemplate rabbitTemplate() {
        //若使用confirm-callback 或 return-callback，必须要配置publicsherConfirms或publisherReturns为true
        //每个rabbitTemplate只能有一个confirm-callback和return-callback，如果这里配置了，那么写生产者的时候不能在写confirm-callback和retuen-callback
        //使用return-callback时不许设置mandatory为true，或者在配置中设置mandatory-expression的值为true
